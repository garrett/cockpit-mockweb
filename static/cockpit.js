...
(function() {
    ...
    var g = null;
    var w = null;
    var b = !!window.ArrayBuffer;
    var y = window.location.origin;
    if (!y) {
        y = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : "");
    }
    function k(e, n) {
        var t = e.length;
        var r = new (n || Array)(t);
    ...
    function S(e) {
        ...
        if (b && e instanceof window.ArrayBuffer) e = new window.Uint8Array(e);
    ...
    function I(e) {
        ...
        if (n.indexOf("http:") === 0) {
            ...
            O("Cockpit must be used over http or https");
            return null;
        }
    }
    function A(e, n) {
    ...
    function B(e) {
        ...
        window.addEventListener("message", function t(r) {
            if (r.origin !== y || r.source !== e) return;
            var i = r.data;
    ...
    function N(e) {
        var n, t, r, i;
        if (b && e instanceof window.ArrayBuffer) {
    ...
    function M() {
        ...
        var s = false;
        var f = false;
        if (window.parent !== window && window.name.indexOf("cockpit1:") === 0) o = new B(window.parent);
        try {
            if (!o && window.parent !== window && window.parent.options && window.parent.options.protocol == "cockpit1") {
                o = new B(window.parent);
            }
        } catch (l) {}
        if (!o) {
            var u = I();
            ...
            if (u) {
                if ("WebSocket" in window) {
                    o = new window.WebSocket(u, "cockpit1");
                } else if ("MozWebSocket" in window) {
                    o = new window.MozWebSocket(u);
                } else {
        ...
        o.onopen = function() {
            if (o) {
                if (typeof o.binaryType !== "undefined" && b) {
        ...
        o.onmessage = e.dispatch_data = function(e) {
            f = true;
            var n = e.data;
            var t = N(n);
            if (t === null) return false;
            var r, i;
            if (b && n instanceof window.ArrayBuffer) r = new window.Uint8Array(n, t.length + 1); else r = n.substring(t.length + 1);
            if (!t) {
                O("recv control:", r);
                i = JSON.parse(r);
            } else {
        ...
        e.close = function J(e) {
            ...
            if (n) n.close();
            x();
            for (var t in y) y[t].apply(null, [ e ]);
        };
        e.next_channel = function P() {
            n++;
            return i + String(n);
        };
        function j(n) {
            ...
            if (t(n["capabilities"] || [], "binary")) e.binary = S;
            if (n["channel-seed"]) i = String(n["channel-seed"]);
            if (n["host"]) h = n["host"];
            if (c) {
                c.options = n;
        ...
        e.send_data = function T(e, n, t) {
            if (!o) {
                console.log("transport closed, dropped message: ", e);
                return false;
            }
            var r, i = w ? w.length : 0;
            for (r = 0; r < i; r++) {
                if (n === undefined) n = N(e);
        ...
        e.send_message = function D(n, t, i) {
            if (t) O("send " + t, n); else O("send control:", n);
            if (n.byteLength || r(n)) {
                if (n instanceof window.ArrayBuffer) n = new window.Uint8Array(n);
                var o = A([ k(t), [ 10 ], n ], true);
                return e.send_data(o.buffer, t, i);
            } else {
                return e.send_data(t.toString() + "\n" + n, t, i);
            }
        };
        e.send_control = function R(n) {
            if (!o && (n.command == "close" || n.command == "kill")) return;
            if (a && n.command == "hint" && n.hint == "ignore_transport_health_check") {
                s = n.data;
                return;
            }
            e.send_message(JSON.stringify(n), "", n);
        };
        e.register = function q(e, n, t) {
            y[e] = n;
            _[e] = t;
        };
    ...
    function J(n) {
        ...
        function v(e) {
            if (s) {
                ...
                if (u) e = j(e, window.Uint8Array || Array);
        ...
        t.send = function b(e) {
            if (o) console.warn("sending message on closed channel"); else if (f) console.warn("sending message after done"); else if (!r) d.push([ false, e ]); else w(e);
        };
        t.control = function y(e) {
            e = e || {};
            if (!e.command) e.command = "options";
            if (e.command === "done") f = true;
            e.channel = l;
            if (!r) d.push([ true, e ]); else r.send_control(e);
        };
        t.wait = function k(n) {
            if (!a) {
                a = e.defer();
    ...
    function T() {
        ...
        function O(e) {
            if (e) b.push(e);
            if (E === null) E = window.setTimeout(x, 0);
        }
        function B(e, n, t, r) {
        ...
        document.addEventListener("click", function(e) {
            if (t(e.target.classList, "disabled")) e.stopPropagation();
        }, true);
        var ie = null;
        function oe() {
        ...
        e.jump = function Xe(n, t) {
            if (r(n)) n = "/" + n.map(encodeURIComponent).join("/").replace("%40", "@").replace("%3D", "="); else n = "" + n;
            var i = {
                command: "jump",
                location: n,
                host: t
        ...
        function pe(n, t) {
            ...
            function E(e, n) {
                le("dbus close:", n);
                l.removeEventListener("ready", _);
                l.removeEventListener("message", w);
                l.removeEventListener("close", E);
                l = null;
                k(n);
            }
            l.addEventListener("control", _);
            l.addEventListener("message", w);
            l.addEventListener("close", E);
            var S = 1;
            this.call = function N(n, t, r, i, o) {
                var a = e.defer();
                var s = String(S);
                S++;
                var l = f({}, o, {
            ...
            function I(e) {
                ...
                if (typeof i[r] != "function") return C(n, t, r);
        ...
        e.message = function un(e) {
            ...
            if (n == "terminated") return be("Your session has been terminated."); else if (n == "no-session") return be("Your session has expired. Please log in again."); else if (n == "access-denied") return be("Not permitted to perform this action."); else if (n == "authentication-failed") return be("Login failed"); else if (n == "authentication-not-supported") return be("The server refused to authenticate using any supported methods."); else if (n == "unknown-hostkey") return be("Untrusted host"); else if (n == "invalid-hostkey") return be("Host key is incorrect"); else if (n == "internal-error") return be("Internal error"); else if (n == "timeout") return be("Connection has timed out."); else if (n == "no-cockpit") return be("Cockpit is not installed on the system."); else if (n == "no-forwarding") return be("Cannot forward login credentials"); else if (n == "disconnected") return be("Server has closed the connection."); else if (n == "not-supported") return be("Cockpit is not compatible with the software on the system."); else if (n == "no-host") return be("Cockpit could not contact the given host."); else return n;
        };
        function ye(e, n, t) {
        ...
        function Ee(n, t) {
            ...
            i.request = function c(n) {
                ...
                var m = c.buffer(function(n) {
                    ...
                    if (p === 1) {
                        ...
                        if (v) {
                            h.headers = h.headers || {};
                            l(v, i, [ h.status, h.headers ]);
                        }
                        return true;
                    }
                    if (h.status >= 200 && h.status <= 299 && d) return d.call(i, n);
                    return 0;
                });
                function g(e, n) {
                    var t = o.indexOf(i);
                    ...
                    if (n.problem) {
                        ...
                        if (h && (h.status < 200 || h.status > 299)) {
                            var s;
                            var f = _e(h.headers, "Content-Type");
                            if (f && !c.binary) {
                                if (f.indexOf("text/plain") === 0) s = a;
                            }
                            ke("http status: ", h.status);
                            r.reject(new ye(h.status, h.reason, s), a);
                        } else {
                            ke("http done");
                            r.resolve(a);
                        }
            ...
            i.post = function v(e, n, t) {
                ...
                if (a(n) || r(n)) {
                    n = JSON.stringify(n);
                    if (_e(t, "Content-Type") === undefined) t["Content-Type"] = "application/json";
    ...
    var D;
    var R = document.scripts[document.scripts.length - 1].src || "";
    var q = R.indexOf("/cockpit.js");
    if (q === -1) q = R.indexOf("/cockpit.min.js");
    if (q !== -1) q = R.substring(0, q).lastIndexOf("/");
    if (q !== -1) {
        D = R.substring(q + 1, R.indexOf(".", q + 1));
        window.cockpit = T();
    }
    if (i(window.define) && window.define.amd) {
        if (D) define(D, [], window.cockpit); else define([], T);
    }
})();
